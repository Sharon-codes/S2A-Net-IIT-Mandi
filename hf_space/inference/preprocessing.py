...
try:
    from inference.pointcloud import load_surface_bytes, detect_and_normalize_units, sample_4096_points
    from inference.alignment import compute_canonical_center
except ImportError:
